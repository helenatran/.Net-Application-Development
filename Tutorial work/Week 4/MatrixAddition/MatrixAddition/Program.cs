    ...
    class Matrix
    {
        ...
        public Matrix()
        {
            ...
            for (int outerLoop = 0; outerLoop < dimension; outerLoop++)
            {
                ...
                {
                    Console.Write("Enter the value of ({0}, {1}): ", outerLoop, innerLoop);
        ...
        public static Matrix operator +(Matrix mat1, Matrix mat2)
        {
            ...
            for (int outerLoop = 0; outerLoop < mat1.dimension; outerLoop++)
            {
                for (int innerLoop = 0; innerLoop < mat1.dimension; innerLoop++)
                {
                    ...
                    tempMatrix.matrix[outerLoop, innerLoop] = 
                        mat1.matrix[outerLoop,innerLoop] + mat2.matrix[outerLoop, innerLoop];
                }
            }
            return tempMatrix;
        }
